...
tab_compara <- compara(unique(conglomerado$nombre))
```
...
```{r, echo=FALSE}
kable(tab_compara[, 1:8] %>% arrange(cgl))
kable(tab_compara[, c(1, 9:14)] %>% arrange(cgl))
kable(tab_compara[, c(1, 15:21)] %>% arrange(cgl))
